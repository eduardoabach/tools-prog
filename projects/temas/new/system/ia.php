...
f17c linux
f188 bug
f086 balões conversa
f087 like
f19c predio grego
f19d chapeu formatura
f091 trofeu
f09b github
f0ac planeta
f0c7 disquete
f1d0 rebelião star wars
f1d1 empério star wars
f1d8 avião de papel
f1e2 bomb
f0e4 velocimetro
f1eb wifi
...
$skillList[] = "Designer";
$skillList[] = "Gaúcho";
$skillList[] = "Fâ de Game of Thrones";
$skillList[] = "Garçom";
$skillList[] = "Traceur";
$skillList[] = "Surfista Amador";
$skillList[] = "Canhoto";
...
$numSkills = count($skillList);
$numS = rand(0, $numSkills - 1);
$skillVerdadeiraRandom = $skillList[$numS];
