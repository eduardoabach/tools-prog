...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Eduardo Bach</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="#portfolio">O quê?</a>
                    </li>
                    <li class="page-scroll">
                        <a href="#objetivos">Por quê?</a>
                    </li>
                    <li class="page-scroll">
    ...
    <header>
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
			<img class="img-responsive img-circle" src="img/profile.jpeg" alt="" style="max-height: 200px; border: 12px solid #2c2c2c;">
		</div>
	    </div>
            <div class="row">
                <div class="col-lg-12">
	...
	<?php include_once("system/analyticstracking.php") ?>
