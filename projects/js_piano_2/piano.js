...
(function() {
  ...
  function fade(key) {
    ...
    return function() {
      clearInterval(intervals[key]);
      intervals[key] = setInterval(stepfade, 5); //default 5, mas na minha opiniao fica um corte muito seco
    };
  };
  ...
  keys.forEach(function(key) {
    ...
    elSound[key] = new Audio('samples/'+key+'.ogg'); 
